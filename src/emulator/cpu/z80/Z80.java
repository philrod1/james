...
public class Z80 {
	...
	private char z80_In(int port) {
		return 0;
//		return (char) machine.readPort(port);
	}
...
//		machine.writePort(Port, Value);
	...
	private final OpcodeFn dec_xhl = new OpcodeFn() {
		public void handler() {
			M_WRMEM(R.HL.W, M_DEC(M_RDMEM(R.HL.W)));
		}
	};
	...
	private final OpcodeFn in_a_byte = new OpcodeFn() {
		public void handler() {
			R.A = z80_In(M_RDMEM_OPCODE());
		}
	};

	private final OpcodeFn inc_xhl = new OpcodeFn() {
		public void handler() {
			M_WRMEM(R.HL.W, M_INC(M_RDMEM(R.HL.W)));
		}
	};
	...
	private final OpcodeFn ld_xbyte_a = new OpcodeFn() {
		public void handler() {
			M_WRMEM(M_RDMEM_OPCODE_WORD(), R.A);
		}
	};
	...
	private final OpcodeFn ld_a_xbyte = new OpcodeFn() {
		public void handler() {
			R.A = M_RDMEM(M_RDMEM_OPCODE_WORD());
		}
	};

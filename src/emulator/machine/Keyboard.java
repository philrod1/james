...
public class Keyboard implements KeyListener {
    ...
    protected void poll() {
        ...
        } else if (isKeyPressed(OSD_KEY_UP) || isKeyPressed(OSD_KEY_W)) {
            System.out.println("UP");
            machine.portWrite(0, (char) (machine.portRead(0) & 0xFE));
        } else if (isKeyPressed(OSD_KEY_LEFT) || isKeyPressed(OSD_KEY_A)) {
            machine.portWrite(0, (char) (machine.portRead(0) & 0xFD));
        } else if (isKeyPressed(OSD_KEY_RIGHT) || isKeyPressed(OSD_KEY_D)) {
            machine.portWrite(0, (char) (machine.portRead(0) & 0xFB));
        } else if (isKeyPressed(OSD_KEY_DOWN) || isKeyPressed(OSD_KEY_S)) {
            machine.portWrite(0, (char) (machine.portRead(0) & 0xF7));
        } else if (isKeyPressed(OSD_KEY_1)) {
